...
export default function OrderClosing() {
  return (
    <section className="relative min-h-[55vh] overflow-hidden bg-black text-white">
      <Image
        src="/images/order/order-closing.jpg"
      ...
      <div className="relative z-10 mx-auto flex min-h-[55vh] max-w-[1440px] items-end px-5 pb-12 sm:px-8 lg:px-14 lg:pb-20">
        <div>
