    ...
    <section className="bg-[#111111] text-white">
      <div className="rr-container py-24 sm:py-32 lg:py-44">
        <div className="grid gap-12 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <Link
            href="/menu"
            className="group inline-flex w-fit items-center gap-5 border-b border-white/30 pb-4 text-[10px] uppercase tracking-[0.2em] transition-colors hover:border-white"
          >
            Explore the menu
